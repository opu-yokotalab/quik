...
comment = hogehoge2];;
#西門/[type=3, url=file:C:/jdk122/Prog/QUIK/java_quik/Media/nisimon2.wrl];;
...
@移動1/[action_type=2, point={(0.0,0.0,0.0),(0.5,0.5,0.0),(0.0,1.0,0.5),(-0.5,1.5,0.0),(0.0,2.0,-0.5),(0.5,3.0,0.0),(0.0,3.5,0.5),(-0.5,4.0,0.0),(0.0,4.5,-0.5),(0.5,5.0,0.0),(0.0,5.5,0.5),(-0.5,6.0,0.0),(0.0,6